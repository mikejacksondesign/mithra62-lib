...
class Files
{
     ...
     * @param mixed $file The file to set
     * @param bool $reset Whether the counter should be reset when set
     ...
     * @param string $mode The access we need to stream the file
     * @return boolean
     */
     ...
     * @param number $digits How many digits to display
     * @param string $mode Either SI or EIC to determine either 1000 or 1024 bytes
     ...
     * @param string $source_dir The path to the directory
     * @param boolean $include_path Whether to include the full path or jsut file name
     * @param boolean $recursion Whether to drill down into further directories
     ...
     * @param string $dir The path to copy
     * @param string $destination The path to save all the files to
     */
    public function copyDir($dir, $destination)
    {
        foreach (
            $iterator = new \RecursiveIteratorIterator(
                new \RecursiveDirectoryIterator(trim($dir), \RecursiveDirectoryIterator::SKIP_DOTS),
