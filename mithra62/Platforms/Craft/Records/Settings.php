...
class Settings extends Records
{
    ...
    {
        return array(
            'setting_key' => array(AttributeType::String, 'colum' => ColumnType::Varchar, 'required' => true),
            'setting_value' => array(AttributeType::String, 'column' => ColumnType::LongText,  'required' => false),
            'serialized' => array(AttributeType::Number, 'column' => ColumnType::TinyInt,  'required' => false, 'default' => 0, 'length' => 1),
        );
    }
    ...
    {
        return array(
            array('columns' => array('setting_key')),
            array('columns' => array('serialized')),
        );
    }
}