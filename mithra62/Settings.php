...
abstract class Settings
{
    ...
    public function update(array $data)
    {
        ...
        foreach($data AS $key => $value)
        {
            ...
            {
                $value = (is_array($value) ? serialize($value) : serialize(array($value)));
            }
    ...
    public function updateSetting($key, $value)
    {
        ...
        return $this->db->update($this->getTable(), $data, array('setting_key' => $key));
    }    
    ...
    {
        return $this->db->select()->from($this->getTable())->where(array('setting_key' => $setting))->get();
    }
