...
class LogsTest extends TestFixture
{
    ...
    {
        $logger = new _logger();
        $logger->setPathToLogFile( $this->getPathToLogFile() )->removeLogFile()->logEmergency('test emergency error message');
    ...
    {
        $logger = new _logger();
        $logger->setPathToLogFile( $this->getPathToLogFile() )->removeLogFile()->logDebug('test debug error message');
        $this->assertTrue(file_exists($this->getPathToLogFile()));
    ...
    {
        $logger = new _logger();
        $logger->setPathToLogFile( $this->getPathToLogFile() )->removeLogFile()->logWarning('test warning error message');
        $this->assertTrue(file_exists($this->getPathToLogFile()));
    ...
    {
        $logger = new _logger();
        $logger->setPathToLogFile( $this->getPathToLogFile() )->removeLogFile()->logError('test error error message');
        $this->assertTrue(file_exists($this->getPathToLogFile()));
