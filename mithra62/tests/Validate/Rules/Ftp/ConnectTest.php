...
class ConnectTest extends TestFixture
{
    ...
    public function testRuleFail()
    {
        ...
        $val->rule('ftp_connect', 'connection_field', $creds)->val(array('connection_field' => __FILE__));
    ...
    {
        $val = new Validate();
        $val->rule('ftp_connect', 'connection_field', $this->getFtpCreds())->val(array('connection_field' => 'Foo'));
