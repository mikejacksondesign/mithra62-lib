...
class LicenseTest extends TestFixture
{
    ...
    {
        $val = new Validate();
        $val->rule('license_key', 'license_key_input')->val(array('license_key_input' => '4435432'));
        $this->assertTrue($val->hasErrors());

        $val = new Validate();
        $val->rule('license_key', 'license_key_input')->val(array('license_key_input' => '55555555-ffff-5555-5555-55555555555'));
        $this->assertTrue($val->hasErrors());
    }
    ...
    {
        $val = new Validate();
        $val->rule('license_key', 'license_key_input')->val(array('license_key_input' => '55555555-5555-5555-5555-555555555555'));
        $this->assertFALSE($val->hasErrors());

        $val = new Validate();
        $val->rule('license_key', 'license_key_input')->val(array('license_key_input' => '55555555-ffff-5555-5555-555555555555'));
        $this->assertFALSE($val->hasErrors());

        $val = new Validate();
        $val->rule('license_key', 'license_key_input')->val(array('license_key_input' => 'ffffffff-ffff-ffff-ffff-ffffffffffff'));
        $this->assertFALSE($val->hasErrors());
    }
}