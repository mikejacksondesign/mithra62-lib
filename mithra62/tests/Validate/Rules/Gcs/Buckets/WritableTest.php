...
class WritableTest extends TestFixture
{
    ...
    public function testRuleFail()
    {
        ...
        $val->rule('gcs_bucket_writable', 'connection_field', $creds)->val(array('connection_field' => __FILE__));
    ...
    {
        $val = new Validate();
        $val->rule('gcs_bucket_writable', 'connection_field', $this->getGcsCreds())->val(array('connection_field' => 'Foo'));
