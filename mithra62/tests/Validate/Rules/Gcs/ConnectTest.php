 ...
 * @version		1.0
 * @filesource 	./mithra62/tests/Validate/Rules/Gcs/ConnectTest.php
 */
 
namespace mithra62\tests\Validate\Rules\Gcs;

use mithra62\tests\TestFixture;
use mithra62\Validate;
use mithra62\Validate\Rules\Gcs\Connect;

/**
 * mithra62 - Gcs Valiate object Unit Tests
 *
...
class ConnectTest extends TestFixture
{
    ...
    public function testRuleFail()
    {
        ...
        $val->rule('gcs_connect', 'connection_field', $creds)->val(array('connection_field' => __FILE__));
    ...
    {
        $val = new Validate();
        $val->rule('gcs_connect', 'connection_field', $this->getGcsCreds())->val(array('connection_field' => 'Foo'));
