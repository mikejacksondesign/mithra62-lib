...
class ExistsTest extends TestFixture
{
    ...
    public function testRuleFail()
    {
        ...
        $val->rule('s3_bucket_exists', 'connection_field', $creds)->val(array('connection_field' => __FILE__));
    ...
    {
        $val = new Validate();
        $val->rule('s3_bucket_exists', 'connection_field', $this->getS3Creds())->val(array('connection_field' => 'Foo'));
